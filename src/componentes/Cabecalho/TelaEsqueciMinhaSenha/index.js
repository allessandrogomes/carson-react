const TelaEsqueciMinhaSenha = ({ aoClicarNoX }) => {
    return (
        <div className="flex flex-col items-center fixed rounded top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-width-400px h-96 bg-teal-400 p-5" id="telaEsqueciMinhaSenha">
            <span onClick={aoClicarNoX} className="w-8 absolute top-2.5 right-2.5 cursor-pointer" id="fecharTelaEsqueciMinhaSenha"><img src="./imagens/Main/botao-fechar.png" alt="Botão fechar tela de Login"/></span>
